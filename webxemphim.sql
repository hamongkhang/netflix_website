...
--
INSERT INTO
  `cates` (`id`, `cate_name`, `created_at`, `updated_at`)
VALUES
...
VALUES
  (
    55,
    56,
    '<iframe width=\"1180\" height=\"664\" src=\"https://www.youtube.com/embed/ileyFOAbvkU\" title=\"The Flash - Official Trailer 2\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>',
    '<iframe width=\"1180\" height=\"664\" src=\"https://www.youtube.com/embed/ileyFOAbvkU\" title=\"The Flash - Official Trailer 2\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>',
    '<iframe width=\"1180\" height=\"664\" src=\"https://www.youtube.com/embed/ileyFOAbvkU\" title=\"The Flash - Official Trailer 2\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>',
    '<iframe width=\"1180\" height=\"664\" src=\"https://www.youtube.com/embed/ileyFOAbvkU\" title=\"The Flash - Official Trailer 2\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>',
    '<iframe width=\"1180\" height=\"664\" src=\"https://www.youtube.com/embed/ileyFOAbvkU\" title=\"The Flash - Official Trailer 2\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>',
...
VALUES
  ...
  (
    25,
    '2020_04_27_145809_create_payments_table',
    11
  ),
  (
    27,
    '2020_04_27_151527_create_wallet_charges_table',
    12
  ),
...
--
INSERT INTO
  `nations` (`id`, `nation_name`, `created_at`, `updated_at`)
VALUES
  (
    1,
    'Mỹ',
...
VALUES
  (
    'vcb000111@cdythadong.edu.vn',
    'VIX48JTBnKpg4Fl5eNmncSeSb9fZtdAzX6jCNRTEqScK43LtewLM39H3Qqbo',
    '2020-04-06 06:47:24',
    '2020-04-06 06:47:24'
  ),
  (
    'vcb000111@cdythadong.edu.vn',
    'CQ9Ec0hpfSNTFeIPdaMd6niEt0ePN9DjokjAldeiQ1mBrtzeb3RRDTlAdrM9',
    '2020-04-06 06:56:21',
    '2020-04-06 06:56:21'
  ),
  (
    'vcb000111@cdythadong.edu.vn',
    '2L1q0CgSPQhcnmImSJjj7ThksD8UIV6lezJToaNsg0496CbepnIEE2g3CvEO',
    '2020-04-19 20:27:02',
    '2020-04-19 20:27:02'
  ),
  (
    'phanvannam0303@gmail',
    'd7eq9x5ctA4h3WYukph7KglVlN9ZBL9iDKAUqvf2tUeUqcpAsDfaHFr2vjuB',
    '2023-04-26 03:36:51',
    '2023-04-26 03:36:51'
  ),
  (
  ...
  (
    'reversal247@gmail.com',
    'AW8keUqoEVtyiaMhC03i5YvHvYunEUDfGIjHWoM36E5axfkBoMyptS0cyFgb',
    '2023-04-29 11:31:25',
    '2023-04-29 11:31:25'
  ),
  (
    'reversal247@gmail.com',
    'DUcGI2pHnUx0A33UnDHTqGGn31VpWXz6pRGkAfaEFC21tbM5F6gW9loIUjE1',
    '2023-04-29 11:31:45',
    '2023-04-29 11:31:45'
  ),
  (
    'reversal247@gmail.com',
    'fdyHi32foqMvzcbQDIK1PaMAgbjHZDMITnMWbytl8LqPhjzf13pkaU7BvhQV',
    '2023-04-29 11:32:08',
    '2023-04-29 11:32:08'
  );
...
VALUES
  (
    17,
    'admin@admin.com',
    '$2y$10$nJUPgh11n4fKg0s18huK6eZykpVnG3XPedtoW0HCBEkRxHdzWbMIq',
    'admin@admin.com',
    'quyen',
    1,
    NULL,
    'zxeZnsy4QC8TMEZ7G0oeemC47eLULAF2xFankAKWzgkrNPx5QC3KBAAiCumX',
    '2023-04-26 02:06:41',
    '2023-04-26 03:29:06'
  ),
  (
    18,
    'truong',
    '$2y$10$P0w2GIpwf9W4FE428KP0oOKKxeVidPA2wP2s0BlIHCmUkEih4k7.C',
    'reversal247@gmail.com',
    'truong',
    0,
    NULL,
    '76Yv2Cpn0TT6sNv9aX0Ko9lIVq7HcUVMBK9LJrjeISghFvgaQcIEWb3is0kA',
    '2023-04-26 03:31:48',
    '2023-04-29 11:45:33'
  );
...
--
INSERT INTO
  `years` (`id`, `year`, `created_at`, `updated_at`)
VALUES
  (
    1,
    '2020',
...
ADD
  PRIMARY KEY (`id`),
ADD
  KEY `cabinets_movie_id_foreign` (`movie_id`),
ADD
  KEY `cabinets_user_id_foreign` (`user_id`);
...
ADD
  PRIMARY KEY (`id`),
ADD
  UNIQUE KEY `cates_cate_name_unique` (`cate_name`);
...
ADD
  PRIMARY KEY (`id`),
ADD
  KEY `links_movie_id_foreign` (`movie_id`);
...
ADD
  KEY `movies_nation_id_foreign` (`nation_id`),
ADD
  KEY `movies_language_id_foreign` (`language_id`),
ADD
  KEY `movies_year_id_foreign` (`year_id`);
...
ADD
  PRIMARY KEY (`id`),
ADD
  UNIQUE KEY `nations_nation_name_unique` (`nation_name`);
...
ADD
  KEY `payments_movie_id_foreign` (`movie_id`);
...
ADD
  PRIMARY KEY (`id`),
ADD
  KEY `wallet_charges_user_id_foreign` (`user_id`),
ADD
  KEY `wallet_charges_wallet_id_foreign` (`wallet_id`);
...
ALTER TABLE
  `cabinets`
ADD
  CONSTRAINT `cabinets_movie_id_foreign` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `cabinets_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE
  `links`
ADD
  CONSTRAINT `links_movie_id_foreign` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE;
...
ALTER TABLE
  `movies`
ADD
  CONSTRAINT `movies_cate_id_foreign` FOREIGN KEY (`cate_id`) REFERENCES `cates` (`id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `movies_language_id_foreign` FOREIGN KEY (`language_id`) REFERENCES `languages` (`id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `movies_nation_id_foreign` FOREIGN KEY (`nation_id`) REFERENCES `nations` (`id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `movies_year_id_foreign` FOREIGN KEY (`year_id`) REFERENCES `years` (`id`) ON DELETE CASCADE;
...
ALTER TABLE
  `payments`
ADD
  CONSTRAINT `payments_movie_id_foreign` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE,
ADD
...
ALTER TABLE
  `wallet_charges`
ADD
  CONSTRAINT `wallet_charges_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `wallet_charges_wallet_id_foreign` FOREIGN KEY (`wallet_id`) REFERENCES `wallets` (`id`) ON DELETE CASCADE;
