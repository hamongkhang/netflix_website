...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 30, 2019 lúc 12:38 PM
...
--
ALTER TABLE `movies`
  MODIFY `idmovie` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
